...
const CalendarApp = () => {
	...
	// 0 here returns the last day of the previous month
	const daysInMonth = new Date(currentYear, currentMonth + 1, 0).getDate()
	const firstDayOfMonth = new Date(currentYear, currentMonth, 1).getDay()

	const prevMonth = () => {
		// 0 is January let's set current month to December
		setCurrentMonth((prevMonth) => (prevMonth === 0 ? 11 : prevMonth - 1))
		// Let's also adjust the year in case of January
	...
	const handleEventSubmit = () => {
		...
		// Date is stored as string, needs to be compared as date objects
